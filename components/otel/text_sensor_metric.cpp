...
TextSensorMetric::TextSensorMetric(MetricsRecorder *otel, text_sensor::TextSensor *sensor, MetricsNamingScheme naming_scheme, uint_fast16_t max_samples)
    : Metric(otel, sensor, "text_sensor", naming_scheme, max_samples) {
  this->sensor = sensor;
}
